...
print('Processing', pdb_in, 'and', 'with', num_steps, 'steps generating outputs',
...
system_generator = SystemGenerator(
    forcefields=[args.protein_force_field, args.additional_protein_force_field, args.water_force_field],
